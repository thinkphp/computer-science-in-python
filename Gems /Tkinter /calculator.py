...
def eval_expression():
     input_string = str(textfield1.get())
     result = eval(input_string)
     textfield3.delete(0, END)
     textfield3.insert(END, result)
...
btnEval = Button(window, text='eval', height= 5, width=10,  command=eval_expression)
btnEval.place(x=440,y=300)
